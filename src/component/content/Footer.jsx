const Footer = ({ blog, location, twitter, company }) => {
    return (
        <footer className="mx-2 mb-6 lg:mx-8 lg:w-5/6 md:w-full w-5/6">
            <div className="grid gap-x-6 md:grid-cols-2 grid-cols-1">
                <div
                    className={`flex items-start py-2 ${location ? "text-lm-blue dark:text-dm-white" : "text-lm-grey"
                        }`}
                >
                    <svg
                ...
                <div
                    className={`flex items-start py-2 ${twitter ? "text-lm-blue dark:text-dm-white" : "text-lm-grey"
                        }`}
                >
                    <svg
                        className="fill-current"
            ...
            <div className="grid gap-x-6 md:grid-cols-2 grid-cols-1">
                <div
                    className={`flex items-start py-2 ${blog ? "text-lm-blue dark:text-dm-white" : "text-lm-grey"
                        }`}
                >
                    <svg
                ...
                <div
                    className={`flex items-start py-2 ${company ? "text-lm-blue dark:text-dm-white" : "text-lm-grey"
                        }`}
                >
                    <svg
                        className="fill-current"
